...
' outer loop-to go through each worksheet
  ...
  For Each ws In Worksheets
      ...
      'Creat the header for columns "Ticker", "Yearly Change", "Percent change" and "Total Stock Volume"
       ...
       ws.Cells(1, 12).Value = "Total Stock Volume"
            ...
            'loop to sum up the volume for each ticker, columns "Ticker" and "Total Stock Volume"
            ...
            '--------------------------calculate yearly change and percent change, considering the zero value------
            ...
            'reset the variables to change the row,reset the total volume for a ticker and change the new open_valu for the next ticker
                ...
                Next i
'-------------------------------------Conditional formatting part for positive and negative values-------------------------------------------------
...
'-------------------------------------------------Challenges------------------------------------------------------------------------
                      '----------name the cells for greatest increase and decrease values and their Tickers-----------
                        ...
                        'loop through the percent change column and total stock volume
